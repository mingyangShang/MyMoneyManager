...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xff39b7e5;//0xffff0000;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0x55000000;//0xFF000000;
...
//	0xff39b7e5,0xffffff,0xff39b7e5
